...
import (
	...
	buUtil "github.com/coreos/ignition/v2/butane/config/util"

	base0_3 "github.com/coreos/ignition/v2/butane/base/v0_3"
	fcos1_0 "github.com/coreos/ignition/v2/butane/config/fcos/v1_0"
	fcos1_1 "github.com/coreos/ignition/v2/butane/config/fcos/v1_1"
	fcos1_2 "github.com/coreos/ignition/v2/butane/config/fcos/v1_2"
	fcos1_3 "github.com/coreos/ignition/v2/butane/config/fcos/v1_3"
	fcos1_4 "github.com/coreos/ignition/v2/butane/config/fcos/v1_4"
	fcos1_5 "github.com/coreos/ignition/v2/butane/config/fcos/v1_5"
	fcos1_6 "github.com/coreos/ignition/v2/butane/config/fcos/v1_6"
	fcos1_7_exp "github.com/coreos/ignition/v2/butane/config/fcos/v1_7_exp"
	fiot1_0 "github.com/coreos/ignition/v2/butane/config/fiot/v1_0"
	fiot1_1_exp "github.com/coreos/ignition/v2/butane/config/fiot/v1_1_exp"
	flatcar1_0 "github.com/coreos/ignition/v2/butane/config/flatcar/v1_0"
	flatcar1_1 "github.com/coreos/ignition/v2/butane/config/flatcar/v1_1"
	flatcar1_2_exp "github.com/coreos/ignition/v2/butane/config/flatcar/v1_2_exp"
	openshift4_10 "github.com/coreos/ignition/v2/butane/config/openshift/v4_10"
	openshift4_11 "github.com/coreos/ignition/v2/butane/config/openshift/v4_11"
	openshift4_12 "github.com/coreos/ignition/v2/butane/config/openshift/v4_12"
	openshift4_13 "github.com/coreos/ignition/v2/butane/config/openshift/v4_13"
	openshift4_14 "github.com/coreos/ignition/v2/butane/config/openshift/v4_14"
	openshift4_15 "github.com/coreos/ignition/v2/butane/config/openshift/v4_15"
	openshift4_16 "github.com/coreos/ignition/v2/butane/config/openshift/v4_16"
	openshift4_17 "github.com/coreos/ignition/v2/butane/config/openshift/v4_17"
	openshift4_18 "github.com/coreos/ignition/v2/butane/config/openshift/v4_18"
	openshift4_19 "github.com/coreos/ignition/v2/butane/config/openshift/v4_19"
	openshift4_20 "github.com/coreos/ignition/v2/butane/config/openshift/v4_20"
	openshift4_21_exp "github.com/coreos/ignition/v2/butane/config/openshift/v4_21_exp"
...
func generate(dir string) error {
	configs := []variant{
		...
		},
		{
			...
			[]version{
				// inverse order of website navbar
				{"4.21.0-experimental", openshift4_21_exp.Config{}},

...
import (
	...
	"github.com/coreos/ignition/v2/butane/config/openshift/v4_20/result"
...
// ToMachineConfig4_20Unvalidated translates the config to a MachineConfig.  It also
...
// ToMachineConfig4_20 translates the config to a MachineConfig.  It returns a
// report of any errors or warnings in the source and resultant config.  If
// the report has fatal errors or it encounters other problems translating,
// an error is returned.
func (c Config) ToMachineConfig4_20(options common.TranslateOptions) (result.MachineConfig, report.Report, error) {
	cfg, r, err := cutil.Translate(c, "ToMachineConfig4_20Unvalidated", options)
